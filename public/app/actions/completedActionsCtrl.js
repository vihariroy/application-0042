angular.module('app').controller('completedActionsCtrl', function($scope, $location, mvIdentity, ngDialog, mvAction, mvAuth, mvNotifier, $modal, mvCachedActions) {
  ...
  $scope.filterActions = function(action) {
    return (!!mvIdentity.currentUser && action.completed === true && action.user._id === mvIdentity.currentUser._id);
  };
