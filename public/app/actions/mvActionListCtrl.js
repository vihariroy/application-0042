angular.module('app').controller('mvActionListCtrl', function($scope, $rootScope, $timeout, $location, ngDialog, mvAction, mvAuth, mvNotifier, $modal, mvCachedActions, cachedMessages, myCachedMessages) {
  ...
  $scope.filterActions = function(action) {
    return (action.completed === undefined && action.private === false);
  };
