angular.module('app').controller('myActionStoryCtrl', function($scope, $routeParams, mvCachedActions, $location, mvIdentity, ngDialog, mvAuth, mvNotifier, $modal) {
  ...
  $scope.filterActions = function(action) {
    return (!!mvIdentity.currentUser && action.user._id === mvIdentity.currentUser._id && !!action.story);
  }
